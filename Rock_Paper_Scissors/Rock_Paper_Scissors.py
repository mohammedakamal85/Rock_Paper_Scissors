...
def start_game():
    # add pictures
    rock_image_comp = ImageTk.PhotoImage(Image.open("Left Rock.jpg"))
    Paper_image_comp = ImageTk.PhotoImage(Image.open("Left Paper.jpg"))
    scissor_image_comp = ImageTk.PhotoImage(Image.open("Left Scissor.jpg"))
    rock_image = ImageTk.PhotoImage(Image.open("Right Rock.jpg"))
    paper_image = ImageTk.PhotoImage(Image.open("Right Paper.jpg"))
    scissor_image = ImageTk.PhotoImage(Image.open("Right Scissor.jpg"))
